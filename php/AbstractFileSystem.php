...
abstract class AbstractFileSystem  implements iFileSystem{
    ...
    protected function top_dir($source){
    ...
    protected function check_path($path, $folder = false, $file = false){
    ...
    abstract protected function makedir($target);

    abstract protected function ren($source, $target, $name);

    abstract protected function move($source, $target);

    abstract protected function copy($source, $target);
}